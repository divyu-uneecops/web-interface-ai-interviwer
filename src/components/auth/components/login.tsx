...
import { validateLoginForm, validateEmailOrPhone, validatePhoneNumber } from "../utils/auth.utils";
...
export default function Login() {
    ...
    const handleSubmit = (values: LoginFormValues) => {
      ...
      console.log("Sending verification code to:", values.emailOrPhone);
                ...
                >
                  {({
                    ...
                    const handleEmailOrPhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
                      ...
                      if (touched.emailOrPhone || submitCount > 0) {
                        setFieldTouched("emailOrPhone", true, false);
                      }
                    };
                        ...
                        <Card className="p-6 flex flex-col gap-6">
                          ...
                          <CardContent className="px-0 pb-0 flex flex-col gap-4">
                            <Input
                              ...
                              onBlur={(e) => {
                                handleBlur(e);
                                setFieldTouched("emailOrPhone", true);
                              }}
                              error={(touched.emailOrPhone || submitCount > 0) && errors.emailOrPhone ? errors.emailOrPhone : undefined}
                            />
                            ...
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => {
                                setFieldValue("keepSignedIn", checked);
                              }}
                            />
