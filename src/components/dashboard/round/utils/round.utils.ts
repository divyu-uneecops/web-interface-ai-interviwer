...
const mapReminderTimeToAPI = (reminderTime: string): string => {
  const timeMap: Record<string, string> = {
    ...
    "1440": "1 day before",
    "2880": "2 days",
    "4320": "3 days", // Adding 3 days option
  };
...
export const transformToAPIPayload = (
  ...
  // Note: For AI questions, the question text will be generated by the backend
  // We send empty strings or placeholder text - backend will replace with actual generated questions
      ...
      questions.push([
        {
          ...
          key: "question",
          value: "", // AI questions will be generated by backend
        },
        {
  ...
  const valuesArray = [
    ...
    },
    {
      ...
      key: "jobName",
      value: "69576a84c9ba83a076aac5a0", // TODO: Get from props or context
    },
    {
